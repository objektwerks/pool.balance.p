...
final case class Cleaning(id: Long = 0,
                          ...
                          cleaned: LocalDateTime = LocalDateTime.now) extends Entity derives CanEqual:
...
final case class Measurement(id: Long = 0,
                             ...
                             salt: Int = 3200,
                             temperature: Int = 85,
                             measured: LocalDateTime = LocalDateTime.now) extends Entity derives CanEqual:
...
final case class Chemical(id: Long = 0,
                          ...
                          added: LocalDateTime = LocalDateTime.now) extends Entity derives CanEqual:
