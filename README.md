...
---------------------------------
>Pool cleaning, measurement and chemical balancing local app using ScalaFx, Scalikejdbc, Ox, H2 and Scala 3.
...
Execute
-------
1. ```java -jar target/scala-3.6.4/poolbalance-2.0.0.jar```
>or:
1. ```java -jar .assembly/poolbalance-2.0.0.jar```
